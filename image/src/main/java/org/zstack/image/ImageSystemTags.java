...
public class ImageSystemTags {
    ...
    public static String IMAGE_HASH_TOKEN = "imageHash";
    public static PatternedSystemTag IMAGE_HASH = new PatternedSystemTag(String.format("imageHash::{%s}", IMAGE_HASH_TOKEN), ImageVO.class);
}
