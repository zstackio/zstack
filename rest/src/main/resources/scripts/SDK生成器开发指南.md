...
private String generateGetMethodForQuery(String apiPath, String viewStructName) {
    ...
    if (placeholders.size() >= 2) {
        ...
        return """
func (cli *ZSClient) Get${resourceName}(${params}) (*view.${viewStructName}, error) {
...
"""
    ...
    // 单参数路径：标准 Get 方法
    return """
func (cli *ZSClient) Get${resourceName}(uuid string) (*view.${viewStructName}, error) {
    var resp view.${viewStructName}
...
```go
// APIQueryGlobalConfigMsg (路径: /global-configurations/{category}/{name})
...
// APIQueryVmInstanceMsg (路径: /vm-instances/{uuid})
...
**案例**：`generateParamFieldGeneric`从单参数改为三参数
...
```groovy
// 模块路径配置
String modulePath = "dev.zstack.io/ye.zou/zstack-go-sdk"
