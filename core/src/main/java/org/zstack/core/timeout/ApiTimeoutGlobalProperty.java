...
public class ApiTimeoutGlobalProperty {
    ...
    @GlobalProperty(name="ApiTimeout.org.zstack.storage.primary.local.APILocalStorageMigrateVolumeMsg", defaultValue = "timeout::3h")
    ...
    @GlobalProperty(name="org.zstack.header.storage.snapshot.APIDeleteVolumeSnapshotMsg", defaultValue = "timeout::3h")
