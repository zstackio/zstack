    ...
    void init() {
        ...
        try {
            ...
            ShellUtils.run(String.format(
                    ...
                    ". /var/lib/zstack/virtualenv/zstacksys/bin/activate; "+
                    "TMPDIR=/usr/local/cloud/ pip install -i file://%s --trusted-host localhost -I setuptools==39.2.0; "+
                    "TMPDIR=/usr/local/cloud/ pip install -i file://%s --trusted-host localhost -I ansible==4.10.0'; "+
