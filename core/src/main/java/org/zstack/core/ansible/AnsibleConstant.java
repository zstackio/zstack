...
public interface AnsibleConstant {
    ...
    public static String PYPI_REPO = PathUtil.getFilePathUnderZStackHomeFolder(String.format("apache-tomcat/webapps/%s/static/pypi/simple",CoreGlobalProperty.APP_NAME));
