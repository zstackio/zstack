...
public class Platform {
    ...
    public static String getManagementServerIp6() {
        String ip = getManagementServerSecondaryIpProperty(MANAGEMENT_SERVER_IP6_PROPERTY);
        if (ip != null) {
            return ip;
        }
    ...
    private static String getManagementServerIp4() {
        String ip = getManagementServerSecondaryIpProperty(MANAGEMENT_SERVER_IP4_PROPERTY);
        if (ip != null) {
            return ip;
        }
    ...
    private static String getManagementServerSecondaryIpProperty(String property) {
