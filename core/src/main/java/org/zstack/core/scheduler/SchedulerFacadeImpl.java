    ...
    private void loadSchedulerManagedByUs() {
        new SQLBatch() {
            ...
            protected void scripts() {
                List<String> managementNodeUuids = Q.New(ManagementNodeVO.class).select(ManagementNodeVO_.uuid).eq(ManagementNodeVO_.uuid, Platform.getManagementServerId()).listValues();
