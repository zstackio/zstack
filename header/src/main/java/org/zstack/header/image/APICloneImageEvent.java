...
public class APICloneImageEvent extends APIEvent {
    public APICloneImageEvent(String apiId) {
        super(apiId);
    }

    public APICloneImageEvent() {
        super(null);
    }
    ...
    public static APICloneImageEvent __example__() {
        APICloneImageEvent event = new APICloneImageEvent();
