 ...
 * @api
 *
 * get a volume snapshot tree for a volume
 *
 ...
 * @result
 *
 * see :ref:`APIGetVolumeSnapshotTreeReply`
 */
public class APIGetVolumeSnapshotTreeMsg extends APISyncCallMessage {
    /**
     * @desc
     * volume uuid. If set, all snapshot trees belonging to this volume will be returned. Could be null
     * @optional
     */
