...
public class APICalculateImageHashOnBackupStorageEvent extends APIEvent {
    private ImageInventory inventory;

    public APICalculateImageHashOnBackupStorageEvent(String apiId) {
        super(apiId);
    }

    public APICalculateImageHashOnBackupStorageEvent() {
        super(null);
    }
    ...
    public static APICalculateImageHashOnBackupStorageEvent __example__() {
        APICalculateImageHashOnBackupStorageEvent event = new APICalculateImageHashOnBackupStorageEvent();
