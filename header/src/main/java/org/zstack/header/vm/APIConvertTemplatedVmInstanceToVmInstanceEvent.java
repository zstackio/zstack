...
public class APIConvertTemplatedVmInstanceToVmInstanceEvent extends APIEvent {
    private VmInstanceInventory inventory;

    public APIConvertTemplatedVmInstanceToVmInstanceEvent() {
        super(null);
    }

    public APIConvertTemplatedVmInstanceToVmInstanceEvent(String apiId) {
        super(apiId);
    }
    ...
    public static APIConvertTemplatedVmInstanceToVmInstanceEvent __example__() {
        APIConvertTemplatedVmInstanceToVmInstanceEvent evt = new APIConvertTemplatedVmInstanceToVmInstanceEvent();
