...
public class APICreateVmInstanceFromVolumeSnapshotGroupEvent extends APIEvent {
    ...
    public APICreateVmInstanceFromVolumeSnapshotGroupEvent() {
        super(null);
    }

    public APICreateVmInstanceFromVolumeSnapshotGroupEvent(String apiId) {
        super(apiId);
    }
