...
public class APIConvertVmTemplateToVmInstanceEvent extends APIEvent {
    private VmInstanceInventory inventory;

    public APIConvertVmTemplateToVmInstanceEvent() {
        super(null);
    }

    public APIConvertVmTemplateToVmInstanceEvent(String apiId) {
        super(apiId);
    }
    ...
    public static APIConvertVmTemplateToVmInstanceEvent __example__() {
        APIConvertVmTemplateToVmInstanceEvent evt = new APIConvertVmTemplateToVmInstanceEvent();
