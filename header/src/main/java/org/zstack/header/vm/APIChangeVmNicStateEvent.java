...
public class APIChangeVmNicStateEvent extends APIEvent {
    ...
    public APIChangeVmNicStateEvent() {
    }

    public APIChangeVmNicStateEvent(String apiId) {
        super(apiId);
    }

    public static APIChangeVmNicStateEvent __example__() {
        APIChangeVmNicStateEvent event = new APIChangeVmNicStateEvent();
