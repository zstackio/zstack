...
public class APIAttachVmNicToVmEvent extends APIEvent {
    ...
    public APIAttachVmNicToVmEvent() {
    }

    public APIAttachVmNicToVmEvent(String apiId) {
        super(apiId);
    }
    ...
    public static APIAttachVmNicToVmEvent __example__() {
        APIAttachVmNicToVmEvent event = new APIAttachVmNicToVmEvent();
