...
public class APICreateVmInstanceFromVolumeSnapshotEvent extends APIEvent {
    ...
    public APICreateVmInstanceFromVolumeSnapshotEvent() {
        super(null);
    }

    public APICreateVmInstanceFromVolumeSnapshotEvent(String apiId) {
        super(apiId);
    }
    ...
    public static APICreateVmInstanceFromVolumeSnapshotEvent __example__() {
        APICreateVmInstanceFromVolumeSnapshotEvent evt = new APICreateVmInstanceFromVolumeSnapshotEvent();
