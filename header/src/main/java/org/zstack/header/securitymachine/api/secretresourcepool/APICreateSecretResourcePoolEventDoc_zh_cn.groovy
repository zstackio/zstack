...
doc {
	...
	ref {
		name "inventory"
		path "org.zstack.header.securitymachine.secretresourcepool.api.APICreateSecretResourcePoolEvent.inventory"
		desc "null"
	...
	ref {
		name "error"
		path "org.zstack.header.securitymachine.secretresourcepool.api.APICreateSecretResourcePoolEvent.error"
