...
doc {
	...
	ref {
		name "inventory"
		path "org.zstack.header.securitymachine.securitymachine.api.APIAddSecurityMachineEvent.inventory"
		desc "null"
	...
	ref {
		name "error"
		path "org.zstack.header.securitymachine.securitymachine.api.APIAddSecurityMachineEvent.error"
