...
doc {
	...
	ref {
		name "inventory"
		path "org.zstack.header.securitymachine.secretresourcepool.api.APIUpdateSecretResourcePoolEvent.inventory"
		desc "null"
	...
	ref {
		name "error"
		path "org.zstack.header.securitymachine.secretresourcepool.api.APIUpdateSecretResourcePoolEvent.error"
