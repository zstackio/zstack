...
trait ApiHelper {
    ...
    def logInByAccessKey(@DelegatesTo(strategy = Closure.OWNER_FIRST, value = org.zstack.sdk.LogInByAccessKeyAction.class) Closure c) {
        def a = new org.zstack.sdk.LogInByAccessKeyAction()
