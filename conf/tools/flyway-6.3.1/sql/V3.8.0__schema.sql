...
ALTER TABLE `zstack`.`StackTemplateVO` MODIFY COLUMN `content` MEDIUMTEXT NOT NULL;

ALTER TABLE AutoScalingGroupActivityVO ADD INDEX indexActivityVOLastOpDate (`lastOpDate`);
ALTER TABLE AutoScalingGroupInstanceVO DROP FOREIGN KEY fkAutoScalingGroupInstanceVOAutoScalingGroupActivityVO;
