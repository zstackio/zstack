-- Repair schema drift for installations that already applied an earlier
-- V5.5.28__schema.sql before the AI host-cache and business-network DDL
-- were moved into that same Flyway version.
