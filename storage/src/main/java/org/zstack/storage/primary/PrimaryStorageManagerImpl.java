...
public class PrimaryStorageManagerImpl extends AbstractService implements PrimaryStorageManager,
    ...
    private void handle(ReleasePrimaryStorageSpaceMsg msg) {
        ...
        if (msg.getAllocatedInstallUrl() == null){
            throw new CloudRuntimeException("---------------------------- ReleasePrimaryStorageSpaceMsg is null ===============================");
        }
        ...
        updater.run(new PrimaryStorageCapacityUpdaterRunnable() {
            ...
            public PrimaryStorageCapacityVO call(PrimaryStorageCapacityVO cap) {
                ...
                if (PSCapacityExt == null) {
                    throw new CloudRuntimeException("---------------------------- Don't deal Primary Storage type ===============================");
                }
                installUrl[0] = PSCapacityExt.reserveCapacity(PSCapacityExt.buildAllocatedInstallUrl(msg, inv), msg.getSize(), msg.getRequiredPrimaryStorageUuid());
                return cap;
            }
        });
        return installUrl[0];
