...
public class LeastVolumePrimaryStorageAllocatorFactory implements PrimaryStorageAllocatorStrategyFactory, Component,
    ...
    private static final PrimaryStorageAllocatorStrategyType type = new PrimaryStorageAllocatorStrategyType(
            PrimaryStorageConstant.LEAST_VOLUME_PRIMARY_STORAGE_ALLOCATION_STRATEGY_TYPE);
    private LeastVolumePrimaryStorageAllocatorStrategy strategy;
    ...
    public boolean start() {
        ...
        strategy = new LeastVolumePrimaryStorageAllocatorStrategy(allocateBuilder, sortBuilder);
        return true;
    }
    ...
    public String getPrimaryStorageAllocatorStrategyName(AllocatePrimaryStorageMsg msg) {
        if (PrimaryStorageConstant.LEAST_VOLUME_PRIMARY_STORAGE_ALLOCATION_STRATEGY_TYPE.equals(msg.getAllocationStrategy())) {
            return PrimaryStorageConstant.LEAST_VOLUME_PRIMARY_STORAGE_ALLOCATION_STRATEGY_TYPE;
        }
        return null;
    }
