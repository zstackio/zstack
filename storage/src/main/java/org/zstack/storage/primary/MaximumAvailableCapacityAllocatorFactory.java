...
public class MaximumAvailableCapacityAllocatorFactory implements PrimaryStorageAllocatorStrategyFactory, Component,
    ...
    private static final PrimaryStorageAllocatorStrategyType type = new PrimaryStorageAllocatorStrategyType(
            PrimaryStorageConstant.MAXIMUM_AVAILABLE_CAPACITY_PRIMARY_STORAGE_ALLOCATION_STRATEGY_TYPE);
    private MaximumAvailableCapacityAllocatorStrategy strategy;
    ...
    public boolean start() {
        ...
        strategy = new MaximumAvailableCapacityAllocatorStrategy(allocateBuilder, sortBuilder);
        return true;
    }
    ...
    public String getPrimaryStorageAllocatorStrategyName(AllocatePrimaryStorageMsg msg) {
        if (PrimaryStorageConstant.MAXIMUM_AVAILABLE_CAPACITY_PRIMARY_STORAGE_ALLOCATION_STRATEGY_TYPE.equals(msg.getAllocationStrategy())) {
            return PrimaryStorageConstant.MAXIMUM_AVAILABLE_CAPACITY_PRIMARY_STORAGE_ALLOCATION_STRATEGY_TYPE;
        }
        return null;
    }
