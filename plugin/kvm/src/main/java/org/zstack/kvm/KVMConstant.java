...
public interface KVMConstant {
    ...
    String KVM_GET_TAKEOVERFLAG_PATH = "/host/takeoverflag/get";
    String KVM_ADD_TAKEOVERFLAG_PATH = "/host/takeoverflag/add";
    String KVM_DELETE_TAKEOVERFLAG_PATH = "/host/takeoverflag/delete";
