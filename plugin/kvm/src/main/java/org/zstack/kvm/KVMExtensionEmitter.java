...
public class KVMExtensionEmitter implements Component {
    ...
    public void doBeforeCommitVolume(Iterator<KVMDeleteVolumeSnapshotSelfExtensionPoint> it, KVMHostInventory host, DeleteVolumeSnapshotSelfOnHypervisorMsg msg, KVMAgentCommands.BlockCommitVolumeCmd cmd, Completion completion) {
        if (!it.hasNext()) {
            completion.success();
            return;
        }
        ...
        ext.beforeDeleteVolumeSnapshotSelf(host, msg, cmd, new Completion(completion) {
            @Override
            public void success() {
    ...
    public void beforeCommitVolume(KVMHostInventory host, DeleteVolumeSnapshotSelfOnHypervisorMsg msg, KVMAgentCommands.BlockCommitVolumeCmd cmd, Completion completion) {
        Iterator<KVMDeleteVolumeSnapshotSelfExtensionPoint> it = deleteVolumeSnapshotSelfExts.iterator();
        doBeforeCommitVolume(it, host, msg, cmd, completion);
    }

    private void doAfterCommitVolume(Iterator<KVMDeleteVolumeSnapshotSelfExtensionPoint> it, KVMHostInventory host, DeleteVolumeSnapshotSelfOnHypervisorMsg msg, KVMAgentCommands.BlockCommitVolumeCmd cmd, DeleteVolumeSnapshotSelfOnHypervisorReply reply, Completion completion) {
        if (!it.hasNext()) {
            completion.success();
            return;
        }
        ...
        KVMDeleteVolumeSnapshotSelfExtensionPoint ext = it.next();
        ext.afterDeleteVolumeSnapshotSelfVolume(host, msg, cmd, reply, new Completion(completion) {
            @Override
            public void success() {
    ...
    public void afterCommitVolume(KVMHostInventory host, DeleteVolumeSnapshotSelfOnHypervisorMsg msg, KVMAgentCommands.BlockCommitVolumeCmd cmd, DeleteVolumeSnapshotSelfOnHypervisorReply reply, Completion completion) {
        Iterator<KVMDeleteVolumeSnapshotSelfExtensionPoint> it = deleteVolumeSnapshotSelfExts.iterator();
        doAfterCommitVolume(it, host, msg, cmd, reply, completion);
    }

    public void failedToCommitVolume(KVMHostInventory host, DeleteVolumeSnapshotSelfOnHypervisorMsg msg, KVMAgentCommands.BlockCommitVolumeCmd cmd, KVMAgentCommands.BlockCommitVolumeResponse rsp, ErrorCode err) {
        for (KVMDeleteVolumeSnapshotSelfExtensionPoint ext : deleteVolumeSnapshotSelfExts) {
            ext.failedToDeleteVolumeSnapshotSelf(host, msg, cmd, rsp, err);
        }
    }
