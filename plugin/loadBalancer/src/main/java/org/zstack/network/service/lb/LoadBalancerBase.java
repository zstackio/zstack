                            ...
                            for (Map<String, String> vmNic : vmNics) {
                                ...
                                if (vmNic.containsKey("weight")) {
                                    ...
                                    if (vmNicWeight < LoadBalancerConstants.BALANCER_WEIGHT_MIN || vmNicWeight > LoadBalancerConstants.BALANCER_WEIGHT_MAX) {
                                        throw new OperationFailureException(argerr("invalid balancer weight[vimNic:%s,weight:%s], [%s] is not in the range [%d, %d]",
                                                vmNicUuid, vmNicWeight,vmNicWeight,LoadBalancerConstants.BALANCER_WEIGHT_MIN, LoadBalancerConstants.BALANCER_WEIGHT_MAX));
                                    }
                        ...
                        if (servers != null) {
                            for (Map<String,String> server: servers) {
                                ...
                                if(server.containsKey("weight")){
                                    ...
                                    if (ipWeight < LoadBalancerConstants.BALANCER_WEIGHT_MIN || ipWeight > LoadBalancerConstants.BALANCER_WEIGHT_MAX) {
                                        throw new OperationFailureException(argerr("invalid balancer weight[ipAddress:%s,weight:%s], [%s] is not in the range [%d, %d]",
                                                ipAddr, ipWeight,ipWeight,LoadBalancerConstants.BALANCER_WEIGHT_MIN, LoadBalancerConstants.BALANCER_WEIGHT_MAX));
                                    }
