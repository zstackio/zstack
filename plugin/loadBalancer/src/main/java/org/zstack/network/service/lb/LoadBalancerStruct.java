...
public class LoadBalancerStruct implements Serializable {
    ...
    private boolean syncAllInstances;
    ...
    public boolean isSyncAllInstances() {
        return syncAllInstances;
    }

    public void setSyncAllInstances(boolean syncAllInstances) {
        this.syncAllInstances = syncAllInstances;
    }
