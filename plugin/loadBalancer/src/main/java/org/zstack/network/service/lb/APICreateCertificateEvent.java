...
public class APICreateCertificateEvent extends APIEvent {
    private CertificateInventory inventory;

    public APICreateCertificateEvent() {
    }

    public APICreateCertificateEvent(String apiId) {
        super(apiId);
    }
    ...
    public static APICreateCertificateEvent __example__() {
        APICreateCertificateEvent event = new APICreateCertificateEvent();
