...
public class APIChangeLoadBalancerListenerBackendServerStateMsg extends APIMessage
    ...
    public static APIChangeLoadBalancerListenerBackendServerStateMsg __example__() {
        APIChangeLoadBalancerListenerBackendServerStateMsg msg =
                new APIChangeLoadBalancerListenerBackendServerStateMsg();
        msg.setListenerUuid(uuid());
        msg.setServerGroupUuid(uuid());
        msg.setVmNicUuids(Collections.singletonList(uuid()));
        msg.setState(LoadBalancerBackendServerState.Disabled.toString());
        return msg;
    }
