    ...
    public boolean start() {
        ...
        bus.installBeforeDeliveryMessageInterceptor(new AbstractBeforeDeliveryMessageInterceptor() {
            ...
            public void beforeDeliveryMessage(Message msg) {
                ...
                String type = Q.New(PrimaryStorageVO.class).eq(PrimaryStorageVO_.uuid, volume.getPrimaryStorageUuid()).find();
                final boolean isLocalPS = LocalStorageConstants.LOCAL_STORAGE_TYPE.equals(type);
