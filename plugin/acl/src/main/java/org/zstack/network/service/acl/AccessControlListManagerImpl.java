...
import org.zstack.network.service.header.acl.*;
 ...
 * @date: 2020-03-12
 **/
public class AccessControlListManagerImpl extends AbstractService implements AccessControlListManager, AddExpandedQueryExtensionPoint {
                ...
                CollectionUtils.safeForEach(pluginRgty.getExtensionList(RefreshAccessControlListExtensionPoint.class),
                        new ForEachFunction<RefreshAccessControlListExtensionPoint>() {
                            ...
                            public void run(RefreshAccessControlListExtensionPoint ext) {
                                ...
                                ext.beforeAddIpEntry(aclVO.toInventory(), entry.toInventory());
                            }
                        });
                ...
                CollectionUtils.safeForEach(pluginRgty.getExtensionList(RefreshAccessControlListExtensionPoint.class),
                        new ForEachFunction<RefreshAccessControlListExtensionPoint>() {
                            ...
                            public void run(RefreshAccessControlListExtensionPoint ext) {
                                ...
                                ext.afterAddIpEntry(aclVO.toInventory(), entry.toInventory());
                            }
                        });
    ...
    private void handle(APIRemoveAccessControlListEntryMsg msg) {
        thdf.chainSubmit(new ChainTask(msg) {
            ...
            public void run(final SyncTaskChain chain) {
                ...
                AccessControlListVO aclVO = dbf.findByUuid(msg.getAclUuid(), AccessControlListVO.class);
                AccessControlListEntryVO entry = dbf.findById(msg.getEntryId(), AccessControlListEntryVO.class);
