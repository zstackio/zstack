...
doc {
	...
	ref {
		name "error"
		path "org.zstack.header.acl.APIChangeAccessControlListRedirectRuleEvent.error"
	...
	ref {
		name "inventory"
		path "org.zstack.header.acl.APIChangeAccessControlListRedirectRuleEvent.inventory"
		desc "null"
