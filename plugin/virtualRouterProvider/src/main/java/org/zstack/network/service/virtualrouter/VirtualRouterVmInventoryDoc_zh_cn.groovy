...
doc {
	...
	ref {
		name "vmNics"
		path "org.zstack.network.service.virtualrouter.VirtualRouterVmInventory.vmNics"
		desc "null"
		type "List"
		since "0.6"
	...
	ref {
		name "allVolumes"
		path "org.zstack.network.service.virtualrouter.VirtualRouterVmInventory.allVolumes"
		desc "null"
		type "List"
		since "0.6"
	...
	ref {
		name "vmCdRoms"
		path "org.zstack.network.service.virtualrouter.VirtualRouterVmInventory.vmCdRoms"
		desc "null"
		type "List"
		since "0.6"
