...
public class CustomerAttachment extends ApiObjectBase {
    ...
    public void setFloatingIp(FloatingIp obj) {
        floating_ip_refs = new ArrayList<ObjectReference<ApiPropertyBase>>();
        floating_ip_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null));
    }
    
    public void addFloatingIp(FloatingIp obj) {
    ...
    public void removeFloatingIp(FloatingIp obj) {
        if (floating_ip_refs != null) {
            floating_ip_refs.remove(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null));
        }
    }
