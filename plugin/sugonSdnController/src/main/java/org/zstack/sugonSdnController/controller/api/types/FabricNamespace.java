...
public class FabricNamespace extends ApiObjectBase {
    ...
    public List<String> getDefaultParent() {
        return Lists.newArrayList("default-global-system-config", "default-fabric");
    }
    ...
    public void setType(String fabric_namespace_type) {
    ...
    public void setValue(NamespaceValue fabric_namespace_value) {
