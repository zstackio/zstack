...
public class Card extends ApiObjectBase {
    private InterfaceMapType interface_map;
    ...
    public InterfaceMapType getInterfaceMap() {
        return interface_map;
    }
    
    public void setInterfaceMap(InterfaceMapType interface_map) {
