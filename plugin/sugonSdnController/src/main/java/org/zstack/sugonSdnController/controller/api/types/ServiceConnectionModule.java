...
public class ServiceConnectionModule extends ApiObjectBase {
    private String e2_service;
    ...
    public String getE2Service() {
        return e2_service;
    }
    
    public void setE2Service(String e2_service) {
        this.e2_service = e2_service;
    }
