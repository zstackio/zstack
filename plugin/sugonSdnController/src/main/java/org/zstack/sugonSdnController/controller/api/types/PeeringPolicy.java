...
public class PeeringPolicy extends ApiObjectBase {
    private String peering_service;
    ...
    public String getPeeringService() {
        return peering_service;
    }
    
    public void setPeeringService(String peering_service) {
        this.peering_service = peering_service;
    }
