...
public class APISdnControllerAddHostEvent extends APIEvent {
    /**
     * @desc see :ref:`SdnControllerInventory`
     */
    private SdnControllerInventory inventory;

    public APISdnControllerAddHostEvent(String apiId) {
        super(apiId);
    }
    ...
    public APISdnControllerAddHostEvent() {
        super(null);
    }
    ...
    public static APISdnControllerAddHostEvent __example__() {
        APISdnControllerAddHostEvent event = new APISdnControllerAddHostEvent();
