...
public class CephBackupStorageBase extends BackupStorageBase {
    ...
    public static class MarkExportImageCmd extends AgentCommand {
        public String installPath;
        public String token;
        public long expireTime;
    }

    public static class MarkExportImageRsp extends AgentResponse {
        public String md5sum;
    }

    public static class UnmarkExportImageCmd extends AgentCommand {
        public String installPath;
    }

    public static class UnmarkExportImageRsp extends AgentResponse {}
    ...
    public static final String MARK_EXPORT_PATH = "/ceph/backupstorage/image/export/mark";
    public static final String UNMARK_EXPORT_PATH = "/ceph/backupstorage/image/export/unmark";
    ...
    private void handle(APIDeleteExportedImageFromBackupStorageMsg msg) {
        ...
        UnmarkExportImageCmd cmd = new UnmarkExportImageCmd();
        cmd.installPath = t.get(0, String.class);
        httpCall(UNMARK_EXPORT_PATH, cmd, UnmarkExportImageRsp.class, new ReturnValueCompletion<UnmarkExportImageRsp>(evt) {
            @Override
            public void success(UnmarkExportImageRsp rsp) {
    ...
    protected void exportImage(APIExportImageFromBackupStorageMsg msg, ReturnValueCompletion<APIExportImageFromBackupStorageEvent> completion) {
        ...
        MarkExportImageCmd cmd = new MarkExportImageCmd();
        cmd.installPath = imageInstallUrl;
        cmd.token = Platform.getUuidFromBytes(msg.getImageUuid().getBytes());
        httpCall(MARK_EXPORT_PATH, cmd, MarkExportImageRsp.class, new ReturnValueCompletion<MarkExportImageRsp>(completion) {
            @Override
            public void success(MarkExportImageRsp rsp) {
