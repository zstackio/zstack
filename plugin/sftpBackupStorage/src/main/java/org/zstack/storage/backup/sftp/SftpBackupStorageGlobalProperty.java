...
public class SftpBackupStorageGlobalProperty {
    @GlobalProperty(name="SftpBackupStorage.agentPackageName", defaultValue = "sftpbackupstorage-0.7.tar.gz")
    ...
    @GlobalProperty(name="SftpBackupStorage.virtualEnvPackage", defaultValue = "sftpbackupstorage-virtualenv.tar.bz")
