...
doc {
    ...
    ref {
        name "inventory"
        path "org.zstack.networksecuritypolicyschedule.APIUpdateNetworkSecurityPolicyScheduleEvent.inventory"
        desc "定时计划清单"
    ...
    ref {
        name "error"
        path "org.zstack.networksecuritypolicyschedule.APIUpdateNetworkSecurityPolicyScheduleEvent.error"
        desc "错误码，操作成功时为null"
        type "ErrorCode"
        since "5.5.38"
        clz ErrorCode.class
