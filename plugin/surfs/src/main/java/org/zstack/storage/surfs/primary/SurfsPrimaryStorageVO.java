...
@AutoDeleteTag
public class SurfsPrimaryStorageVO extends PrimaryStorageVO {
    @OneToMany(fetch= FetchType.EAGER)
    @JoinColumn(name="primaryStorageUuid", insertable=false, updatable=false)
    @NoView
    private Set<SurfsPrimaryStorageNodeVO> nodes = new HashSet<SurfsPrimaryStorageNodeVO>();
    ...
    public SurfsPrimaryStorageVO() {
    }

    public SurfsPrimaryStorageVO(PrimaryStorageVO other) {
        super(other);
    }

    public SurfsPrimaryStorageVO(SurfsPrimaryStorageVO other) {
        super(other);
        this.nodes = other.nodes;
        this.fsid = other.fsid;
    }

    public Set<SurfsPrimaryStorageNodeVO> getNodes() {
        return nodes;
    }

    public void setNodes(Set<SurfsPrimaryStorageNodeVO> nodes) {
        this.nodes = nodes;
    }
