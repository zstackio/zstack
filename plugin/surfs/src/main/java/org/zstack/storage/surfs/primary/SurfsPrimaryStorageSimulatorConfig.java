 ...
 */
public class SurfsPrimaryStorageSimulatorConfig {
    public static class SurfsPrimaryStorageConfig {
    ...
    public Map<String, SurfsPrimaryStorageConfig> config = new HashMap<String, SurfsPrimaryStorageConfig>();
