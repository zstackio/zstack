...
import org.zstack.storage.surfs.primary.SurfsPrimaryStorageNodeInventory
...
doc {
	...
	ref {
		name "nodes"
		path "org.zstack.storage.surfs.primary.SurfsPrimaryStorageInventory.nodes"
		desc "null"
		type "List"
		since "0.6"
		clz SurfsPrimaryStorageNodeInventory.class
	}
	field {
		name "fsid"
		desc ""
