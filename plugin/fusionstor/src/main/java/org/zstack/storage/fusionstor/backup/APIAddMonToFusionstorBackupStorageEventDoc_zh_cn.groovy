...
doc {
	...
	ref {
		name "error"
		path "org.zstack.storage.fusionstor.backup.APIAddMonToFusionstorBackupStorageEvent.error"
	...
	ref {
		name "inventory"
		path "org.zstack.storage.fusionstor.backup.APIAddMonToFusionstorBackupStorageEvent.inventory"
		desc "null"
