...
doc {
	...
	ref {
		name "error"
		path "org.zstack.storage.fusionstor.backup.APIRemoveMonFromFusionstorBackupStorageEvent.error"
	...
	ref {
		name "inventory"
		path "org.zstack.storage.fusionstor.backup.APIRemoveMonFromFusionstorBackupStorageEvent.inventory"
		desc "null"
