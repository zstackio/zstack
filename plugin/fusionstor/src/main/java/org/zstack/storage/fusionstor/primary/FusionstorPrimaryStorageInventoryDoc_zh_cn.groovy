...
import org.zstack.storage.fusionstor.primary.FusionstorPrimaryStorageMonInventory
...
doc {
	...
	ref {
		name "mons"
		path "org.zstack.storage.fusionstor.primary.FusionstorPrimaryStorageInventory.mons"
		desc "null"
		type "List"
		since "0.6"
		clz FusionstorPrimaryStorageMonInventory.class
	}
	field {
		name "fsid"
		desc ""
