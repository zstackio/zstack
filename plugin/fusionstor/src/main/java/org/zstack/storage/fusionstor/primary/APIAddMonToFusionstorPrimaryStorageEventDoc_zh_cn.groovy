...
doc {
	...
	ref {
		name "error"
		path "org.zstack.storage.fusionstor.primary.APIAddMonToFusionstorPrimaryStorageEvent.error"
	...
	ref {
		name "inventory"
		path "org.zstack.storage.fusionstor.primary.APIAddMonToFusionstorPrimaryStorageEvent.inventory"
		desc "null"
