...
public class FusionstorGlobalProperty {
    ...
    @GlobalProperty(name="Fusionstor.backupStorage.agentPackageName", defaultValue = "fusionstorbackupstorage-1.7.tar.gz")
    ...
    @GlobalProperty(name="Fusionstor.primaryStorage.agentPackageName", defaultValue = "fusionstorprimarystorage-1.7.tar.gz")
