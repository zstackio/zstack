...
public class FusionstorGlobalProperty {
    ...
    @GlobalProperty(name="Fusionstor.backupStorage.agentPackageName", defaultValue = "fusionstorbackupstorage-3.2.0.tar.gz")
    ...
    @GlobalProperty(name="Fusionstor.primaryStorage.agentPackageName", defaultValue = "fusionstorprimarystorage-3.2.0.tar.gz")
