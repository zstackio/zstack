...
public class FusionstorGlobalProperty {
    ...
    @GlobalProperty(name="Fusionstor.backupStorage.agentPackageName", defaultValue = "fusionstorbackupstorage-1.6.tar.gz")
    ...
    @GlobalProperty(name="Fusionstor.primaryStorage.agentPackageName", defaultValue = "fusionstorprimarystorage-1.6.tar.gz")
