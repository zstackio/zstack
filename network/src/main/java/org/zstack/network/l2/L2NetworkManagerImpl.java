...
public class L2NetworkManagerImpl extends AbstractService implements L2NetworkManager {
    ...
    private void handle(CreateL2NetworkMsg msg) {
        ...
        if (apiMsg != null && !msg.getType().equals(apiMsg.getType())) {
            bus.replyErrorByMessageType(msg, err(ORG_ZSTACK_NETWORK_L2_10025, SysErrors.INVALID_ARGUMENT_ERROR,
            ...
            bus.replyErrorByMessageType(msg, err(ORG_ZSTACK_NETWORK_L2_10026, SysErrors.INVALID_ARGUMENT_ERROR,
    ...
    private void handle(APICreateL2NetworkMsg msg, NetworkCreateContext context,
        ...
        for (L2NetworkCreateExtensionPoint extp : createExtensions) {
            try {
                ...
                ErrorCode error = err(ORG_ZSTACK_NETWORK_L2_10027, SysErrors.CREATE_RESOURCE_ERROR,
        ...
        if (accountUuid == null) {
            completion.fail(err(ORG_ZSTACK_NETWORK_L2_10028, SysErrors.INVALID_ARGUMENT_ERROR,
