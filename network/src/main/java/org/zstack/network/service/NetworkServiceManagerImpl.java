...
public class NetworkServiceManagerImpl extends AbstractService implements NetworkServiceManager, PreVmInstantiateResourceExtensionPoint,
    ...
    @Override
    public void releaseNetworkServiceOnChangeIP(VmInstanceSpec spec, Completion completion) {
        releaseNetworkServices(spec, null, new NoErrorCompletion(completion) {
            @Override
            public void done() {
                completion.success();
    ...
    @Override
    public void applyNetworkServiceOnChangeIP(VmInstanceSpec spec, Completion completion) {
