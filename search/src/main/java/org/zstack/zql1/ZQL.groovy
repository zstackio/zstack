...
import org.zstack.zql1.antlr4.ZQLLexer
import org.zstack.zql1.antlr4.ZQLParser
import org.zstack.header.zql.ASTNode
import org.zstack.zql1.ast.ZQLMetadata
import org.zstack.zql1.ast.parser.visitors1.CountVisitor
import org.zstack.zql1.ast.parser.visitors1.QueryVisitor
import org.zstack.zql1.ast.visitors.result.QueryResult
...
class ZQL {
    ...
    ZQLQueryResult execute() {
        ...
        if (ctx instanceof ZQLParser.CountGrammarContext) {
            ...
            astResult = query.accept(new org.zstack.zql1.ast.visitors.QueryVisitor(countQuery: true)) as QueryResult
            ...
            callExtensions(query)
            astResult = query.accept(new org.zstack.zql1.ast.visitors.QueryVisitor()) as QueryResult
