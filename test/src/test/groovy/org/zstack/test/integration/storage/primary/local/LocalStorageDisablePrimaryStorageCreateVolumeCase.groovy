 ...
 */
class LocalStorageDisablePrimaryStorageCreateVolumeCase extends SubCase{
    EnvSpec env
    ...
    void test() {
        env.create {
            testLocalStorageCreateVolumeWhenPrimaryStorageIsDisabled()
        }
    }


    void testLocalStorageCreateVolumeWhenPrimaryStorageIsDisabled() {
