 ...
 */
class LocalStorageMaintenancePrimaryStorageDeleteSharedVolumeCase extends SubCase{
    EnvSpec env
    ...
    void test() {
        env.create {
            testLocalStorageDeleteSharedVolumeWhenPrimaryStorageIsMaintained()
        }
    }

    void testLocalStorageDeleteSharedVolumeWhenPrimaryStorageIsMaintained() {
