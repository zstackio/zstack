...
//    def load = env.inventoryByName("lb-group-1") as LoadBalancerInventory
...
//        CreateLoadBalancerServerGroupAction action1 = new CreateLoadBalancerServerGroupAction()
//        action1.loadBalancerUuid =
//        action1.
//        action1.
//        action1.sessionId = adminSession()
//        CreateLoadBalancerServerGroupAction.Result servergroupResult1 = action1.call()
//        servergroup1 = servergroupResult1.value.inventory

//        CreateLoadBalancerServerGroupAction action2 = new CreateLoadBalancerServerGroupAction()
//        action2.loadBalancerUuid = lb.uuid
//        action2.name = "lb-group-2"
//        action2.weight = 20
//        action2.sessionId = adminSession()
//
//        CreateLoadBalancerServerGroupAction.Result servergroupResult2 = action2.call()
//        servergroup2 = servergroupResult2.value.inventory
...
//        action.weight = 40
//        action.uuid = servergroup1.uuid
//        action1.sessionId = adminSession()
//        UpdateLoadBalancerServerGroupAction.Result servergroupResult = action.call()
//        LoadBalancerServerGroupInventory  servergroup = servergroupResult.value.inventory
