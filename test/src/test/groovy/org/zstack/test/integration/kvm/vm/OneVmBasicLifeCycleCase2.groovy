...
import org.zstack.testlib.CreateAction
 ...
 */
class OneVmBasicLifeCycleCase2 extends SubCase {
    EnvSpec env
...
"""
    ...
    void testCreateVm() {
        CreateZoneAction ca = new CreateZoneAction()
        ca.sessionId = adminSession()
        ca.name = "zone"
        CreateZoneAction.Result ret = ca.call()
    }
