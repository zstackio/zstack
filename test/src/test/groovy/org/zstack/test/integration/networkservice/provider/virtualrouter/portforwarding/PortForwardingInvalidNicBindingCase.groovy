...
class PortForwardingInvalidNicBindingCase extends SubCase {
    ...
    void testInvalidNicDoesNotLeaveStaleBinding() {
        ...
        expectApiFailure {
            ...
            assert code == SysErrors.OPERATION_ERROR.toString()
            assert details.contains(publicNic.l3NetworkUuid)
            assert details.contains("[type:${NetworkServiceType.PortForwarding}]")
        }
