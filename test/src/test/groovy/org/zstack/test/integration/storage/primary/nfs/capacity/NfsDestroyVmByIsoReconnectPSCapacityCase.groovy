 ...
 */
class NfsDestroyVmByIsoReconnectPSCapacityCase extends SubCase {
    EnvSpec env
    ...
    void test() {
        env.create {
            testDestroyVmByIsoReconnectPSCheckCapacity()
        }
    }

    void testDestroyVmByIsoReconnectPSCheckCapacity() {
        ...
        ImageInventory image = env.inventoryByName("test-iso1")
