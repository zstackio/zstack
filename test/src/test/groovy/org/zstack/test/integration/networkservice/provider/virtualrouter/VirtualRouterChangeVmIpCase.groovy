...
class VirtualRouterChangeVmIpCase extends SubCase {
    ...
    void testPFWhenChangeIp() {
        ...
        VmInstanceInventory vm = createVmInstance {
            ...
            systemTags = [String.format("staticIp::%s::%s", vr_l3.uuid, ip1)]
        }
