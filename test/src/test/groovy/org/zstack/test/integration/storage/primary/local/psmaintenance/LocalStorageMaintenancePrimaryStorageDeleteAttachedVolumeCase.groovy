 ...
 */
class LocalStorageMaintenancePrimaryStorageDeleteAttachedVolumeCase extends SubCase{
    EnvSpec env
    ...
    void test() {
        env.create {
            testLocalStorageDeleteAttachedVolumeWhenPrimaryStorageIsMaintained()
        }
    }

    void testLocalStorageDeleteAttachedVolumeWhenPrimaryStorageIsMaintained() {
