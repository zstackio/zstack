 ...
 */
class LocalStorageMaintenancePrimaryStorageDeleteVolumeCase extends SubCase{
    EnvSpec env
    ...
    void test() {
        env.create {
            testLocalStorageDeleteVolumeWhenPrimaryStorageIsMaintained()
        }
    }

    void testLocalStorageDeleteVolumeWhenPrimaryStorageIsMaintained() {
