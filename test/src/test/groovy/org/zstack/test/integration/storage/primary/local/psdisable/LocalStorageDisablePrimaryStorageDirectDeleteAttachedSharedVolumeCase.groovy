 ...
 */
class LocalStorageDisablePrimaryStorageDirectDeleteAttachedSharedVolumeCase extends SubCase{
    EnvSpec env
    ...
    void test() {
        env.create {
            testLocalStorageDirectDeleteAttachedSharedVolumeWhenPrimaryStorageIsDisabled()
        }
    }


    void testLocalStorageDirectDeleteAttachedSharedVolumeWhenPrimaryStorageIsDisabled() {
