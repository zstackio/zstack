...
class ColdMigrateVmToAnotherClusterCase extends SubCase{
    ...
    void testGetVolumeMigratableHosts(){
        VmInstanceInventory vmi = env.inventoryByName("vm") as VmInstanceInventory
        List<HostInventory> list =  localStorageGetVolumeMigratableHosts {
    ...
    void testMigrateVmToCluster(){
        VmInstanceInventory vmi = env.inventoryByName("vm") as VmInstanceInventory
        HostInventory hosti = env.inventoryByName("kvm2") as HostInventory
        ClusterInventory clusteri = env.inventoryByName("cluster1-2") as ClusterInventory
        stopVmInstance {
            uuid = vmi.uuid
        }
        retryInSecs{
    ...
    void testMigrateVmToClusterNetworkNotSatisfactory(){
        VmInstanceInventory vmi = env.inventoryByName("vm") as VmInstanceInventory
        HostInventory hosti = env.inventoryByName("kvm3") as HostInventory
        ClusterInventory clusteri = env.inventoryByName("cluster2-1") as ClusterInventory
