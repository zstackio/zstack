...
class CreateSnapshotRollbackAfterDataPlaneSuccessCase extends SubCase {
    ...
    void testKeepSnapshotMetadataWhenControlPlaneFailsAfterDataPlaneSuccess() {
        ...
        pluginRegistry.defineDynamicExtension(AfterCreateVolumeSnapshotExtensionPoint.class, failureExtension)
        ...
        try {
            ...
            pluginRegistry.getExtensionList(AfterCreateVolumeSnapshotExtensionPoint.class).remove(failureExtension)
        }
    }
