...
class FlatWithIpamCase extends SubCase{
    ...
    void testEipWithoutIpam(){
        ...
        IpRangeInventory pubIpr6 = (queryIpRange {
            conditions = ["l3NetworkUuid=${pub.uuid}", "ipVersion=${IPv6Constants.IPv6}"]
        } as List<IpRangeInventory>).get(0)
