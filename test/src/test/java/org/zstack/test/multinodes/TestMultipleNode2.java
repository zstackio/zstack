 ...
 */
public class TestMultipleNode2 {
    CLogger logger = Utils.getLogger(TestMultipleNode2.class);
    ComponentLoader loader;
    Deployer deployer;
    NodeManager nodeMgr;
    Api api;
    ResourceDestinationMakerImpl destinationMaker;
    ...
    public void setUp() throws Exception {
        ...
        destinationMaker = loader.getComponent(ResourceDestinationMakerImpl.class);
    ...
    public void test() throws InterruptedException, ApiSenderException {
        try {
            ...
            api.setTimeout(300);
            create100Vm();
            final NodeRunner node = nodeMgr.getNodes().get(0);
            nodeMgr.stopNode(node.getManagementNodeId(), 120);
