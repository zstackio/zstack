...
import org.zstack.test.deployer.schema.BackupStorageUnion;
import org.zstack.test.deployer.schema.ClusterUnion;
import org.zstack.test.deployer.schema.DeployerConfig;
import org.zstack.test.deployer.schema.DiskOfferingConfig;
import org.zstack.test.deployer.schema.EipUnion;
import org.zstack.test.deployer.schema.GroupConfig;
import org.zstack.test.deployer.schema.HostUnion;
import org.zstack.test.deployer.schema.ImageUnion;
import org.zstack.test.deployer.schema.InstanceOfferingUnion;
import org.zstack.test.deployer.schema.IpRangeConfig;
import org.zstack.test.deployer.schema.L2NetworkUnion;
import org.zstack.test.deployer.schema.L3NetworkUnion;
import org.zstack.test.deployer.schema.LbUnion;
import org.zstack.test.deployer.schema.NetworkServiceConfig;
import org.zstack.test.deployer.schema.PortForwardingUnion;
import org.zstack.test.deployer.schema.PrimaryStorageUnion;
import org.zstack.test.deployer.schema.SecurityGroupUnion;
import org.zstack.test.deployer.schema.UserConfig;
import org.zstack.test.deployer.schema.VmUnion;
import org.zstack.test.deployer.schema.ZoneUnion;
