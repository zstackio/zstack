 ...
 *
 * confirm the snapshot is still on primary storage
 */
public class TestIscsiBtrfsPrimaryStorage20 {
    Deployer deployer;
    Api api;
    ...
    public void test() throws ApiSenderException, InterruptedException {
        ...
        Assert.assertNotNull(spvo.getPrimaryStorageUuid());
        Assert.assertNotNull(spvo.getPrimaryStorageInstallPath());
    }
}
