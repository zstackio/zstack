...
* 2. backup snapshot 4 to sftp1
* 3. destroy vm
*
* confirm all snapshot are still on backup storage
*/
public class TestSnapshotOnKvm24 {
    CLogger logger = Utils.getLogger(TestSnapshotOnKvm24.class);
    Deployer deployer;
    Api api;
    ...
    public void test() throws ApiSenderException, InterruptedException {
        ...
        count = q.count();
        Assert.assertEquals(4, count);
        Assert.assertEquals(0, sftpConfig.deleteCmds.size());
