...
public class TestSftpBackupStoragePing {
    CLogger logger = Utils.getLogger(TestSftpBackupStoragePing.class);
    Deployer deployer;
    Api api;
    ...
    public void test() throws ApiSenderException, InterruptedException {
        ...
        TimeUnit.SECONDS.sleep(3);
        bvo = dbf.findByUuid(sinv.getUuid(), BackupStorageVO.class);
