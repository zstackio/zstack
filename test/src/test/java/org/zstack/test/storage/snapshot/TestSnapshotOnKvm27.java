...
import org.zstack.header.storage.snapshot.VolumeSnapshotBackupStorageRefVO_;
...
* 4. delete snapshot 4 from sftp
*
* confirm all snapshot are still on backup storage
*/
public class TestSnapshotOnKvm27 {
    CLogger logger = Utils.getLogger(TestSnapshotOnKvm27.class);
    Deployer deployer;
    Api api;
    ...
    public void test() throws ApiSenderException, InterruptedException {
        ...
        Assert.assertEquals(2, inv3.getBackupStorageRefs().size());
        ...
        inv3 = api.deleteSnapshotFromBackupStorage(inv3.getUuid(), bs.getUuid());

        Assert.assertEquals(1, inv3.getBackupStorageRefs().size());
