 ...
 *
 * confirm the template is created successfully
 */
public class TestIscsiBtrfsPrimaryStorage16 {
    Deployer deployer;
    Api api;
    ...
    public void test() throws ApiSenderException, InterruptedException {
        ...
        UploadToSftpCmd cmd = iconfig.uploadToSftpCmds.get(0);
        Assert.assertNotNull(cmd.getPrimaryStorageInstallPath());
        Assert.assertNotNull(cmd.getBackupStorageInstallPath());
    }
}
