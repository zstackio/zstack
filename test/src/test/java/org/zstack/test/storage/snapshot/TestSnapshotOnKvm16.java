...
* 2. set snapshot backup to failure
* 2. backup snapshot 4
*
* confirm no snapshot are backed up
*/
public class TestSnapshotOnKvm16 {
    CLogger logger = Utils.getLogger(TestSnapshotOnKvm16.class);
    Deployer deployer;
    Api api;
