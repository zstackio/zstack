...
*
* confirm snapshots are deleted on primary storage but still on backup storage
*/
public class TestSnapshotOnKvm30 {
    CLogger logger = Utils.getLogger(TestSnapshotOnKvm30.class);
    Deployer deployer;
    Api api;
