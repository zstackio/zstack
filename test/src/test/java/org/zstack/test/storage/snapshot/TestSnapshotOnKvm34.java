...
* 3. create volume from snapshot 4 with specified primary storage
*
...
public class TestSnapshotOnKvm34 {
    ...
    public void test() throws ApiSenderException {
        ...
        String targetPriUuid = dataVol.getPrimaryStorageUuid().equals(nfs.getUuid()) ? nfs1.getUuid() : nfs.getUuid();

        VolumeInventory vol = api.createDataVolumeFromSnapshot(inv.getUuid(), targetPriUuid);
        Assert.assertEquals(targetPriUuid, vol.getPrimaryStorageUuid());
