 ...
 * 4. remove vm1 from sg2
 * @test confirm rules of sg1 are still on vm1
 */
public class TestSecurityGroupRuleInTwoGroup5 {
    static CLogger logger = Utils.getLogger(TestSecurityGroupRuleInTwoGroup5.class);
    ...
    public void test() throws ApiSenderException, InterruptedException {
        ...
        api.removeVmNicFromSecurityGroup(scinv2.getUuid(), vm1Nic.getUuid());
        TimeUnit.MILLISECONDS.sleep(500);
