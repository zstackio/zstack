 ...
 * 
 * @test
 * confirm rules on vm1Nic1, vm1Nic2 are correct
 *
 */
public class TestSecurityGroupOnMultipleNetworks7 {
    static CLogger logger = Utils.getLogger(TestSecurityGroupOnMultipleNetworks7.class);
    ...
    public void test() throws ApiSenderException, InterruptedException {
        ...
        SecurityGroupTestValidator.validateInternalIpNotIn(vm1Nic2TO, vm2Nic1.getIp(), scinv.getRules());
