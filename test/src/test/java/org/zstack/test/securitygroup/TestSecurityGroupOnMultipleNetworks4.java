 ...
 * 7. remove vm2Nic1 from sg
 * @test confirm after removing vm2Nic1, rules on vm1Nic1, vm2Nic2 are correct
 */
public class TestSecurityGroupOnMultipleNetworks4 {
    static CLogger logger = Utils.getLogger(TestSecurityGroupOnMultipleNetworks4.class);
    ...
    public void test() throws ApiSenderException, InterruptedException {
        ...
        api.removeVmNicFromSecurityGroup(scinv.getUuid(), vm2Nic1.getUuid());
        TimeUnit.MILLISECONDS.sleep(500);
        vm1Nic1TO = sbkd.getRulesOnHost(vm1.getHostUuid(), vm1Nic1.getInternalName());
        SecurityGroupTestValidator.validateInternalIpNotIn(vm1Nic1TO, vm2Nic1.getIp(), scinv.getRules());
        vm2Nic2TO = sbkd.getRulesOnHost(vm2.getHostUuid(), vm2Nic2.getInternalName());
        SecurityGroupTestValidator.validate(vm2Nic2TO, scinv.getRules());

        vm2Nic1TO = sbkd.getRulesOnHost(vm2.getHostUuid(), vm2Nic1.getInternalName());
