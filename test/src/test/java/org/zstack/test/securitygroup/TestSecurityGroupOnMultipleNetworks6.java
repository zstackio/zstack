 ...
 */
public class TestSecurityGroupOnMultipleNetworks6 {
    static CLogger logger = Utils.getLogger(TestSecurityGroupOnMultipleNetworks6.class);
    ...
    public void test() throws ApiSenderException, InterruptedException {
        ...
        vm2 = api.startVmInstance(vm2.getUuid());
        TimeUnit.MILLISECONDS.sleep(500);
