...
public class TestSecurityGroupOnMultipleNetworks {
    ...
    public void test() throws ApiSenderException, InterruptedException {
        ...
        SecurityGroupTestValidator.validateInternalIpNotIn(vm1Nic1TO, vm1Nic2.getIp(), scinv.getRules());
        ...
        SecurityGroupTestValidator.validateInternalIpNotIn(vm2Nic1TO, vm1Nic2.getIp(), scinv.getRules());
        ...
        SecurityGroupTestValidator.validateInternalIpNotIn(vm1Nic2TO, vm1Nic1.getIp(), scinv.getRules());
