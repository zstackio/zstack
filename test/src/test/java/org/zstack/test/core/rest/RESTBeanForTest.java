...
public class RESTBeanForTest {
    ...
    public @ResponseBody String testCallback(HttpServletRequest  req, HttpServletResponse rsp) throws InterruptedException, IOException {
    ...
    public @ResponseBody String testCallbackJson(HttpServletRequest  req, HttpServletResponse rsp) throws InterruptedException, IOException {
        HttpEntity<String> entity = restf.httpServletRequestToHttpEntity(req);
        callItBack(entity);
        return "";
    }
    ...
    public @ResponseBody String testCallbackTimeout(HttpServletRequest  req, HttpServletResponse rsp) throws InterruptedException, IOException {
        /* do nothing, emulate a timeout */
        return "";
    }
    
    @RequestMapping(value=RESTBeanForTest.CALLBACK_FAIL_PATH, method=RequestMethod.POST)
    public @ResponseBody String testCallbackFail(HttpServletRequest  req, HttpServletResponse rsp) throws InterruptedException, IOException {
        /* do nothing, emulate a timeout */
    ...
    public @ResponseBody String testCallbackMissingTaskUuid(HttpServletRequest  req, HttpServletResponse rsp) throws InterruptedException, IOException {
        HttpEntity<String> entity = restf.httpServletRequestToHttpEntity(req);
