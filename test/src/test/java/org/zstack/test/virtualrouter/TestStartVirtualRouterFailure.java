...
public class TestStartVirtualRouterFailure {
    CLogger logger = Utils.getLogger(TestStartVirtualRouterFailure.class);
    Deployer deployer;
    Api api;
    ...
    public void test() throws ApiSenderException {
        ...
        final APICreateVmInstanceMsg msg = new APICreateVmInstanceMsg();
        ...
        Assert.assertEquals(0, kconfig.vms.size());
    }
