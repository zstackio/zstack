...
public class TestUpdateIpRange {
    Api api;
    ...
    public void test() throws ApiSenderException {
        ...
        ipInv.setName("1");
        ipInv.setDescription("xxx");
        ipInv = api.updateIpRange(ipInv);
        Assert.assertEquals("1", ipInv.getName());
        Assert.assertEquals("xxx", ipInv.getDescription());
    }
