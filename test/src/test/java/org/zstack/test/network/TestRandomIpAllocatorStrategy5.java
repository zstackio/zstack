...
public class TestRandomIpAllocatorStrategy5 {
    CLogger logger = Utils.getLogger(TestRandomIpAllocatorStrategy5.class);
    Api api;
    ...
    public void test() throws ApiSenderException {
        ...
        String endIp = NetworkUtils.longToIpv4String(NetworkUtils.ipv4StringToLong(startIp) + 1000);
