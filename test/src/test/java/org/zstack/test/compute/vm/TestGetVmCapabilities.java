...
public class TestGetVmCapabilities {
    ...
    public void test() throws ApiSenderException {
        ...
        ImageVO vo = dbf.findByUuid(vm.getImageUuid(), ImageVO.class);

        Assert.assertTrue(vo.getMediaType() == ImageConstant.ImageMediaType.ISO);
        ...
        Assert.assertFalse((Boolean) cap.get(VmInstanceConstant.Capability.Reimage.toString()));
    }
}
