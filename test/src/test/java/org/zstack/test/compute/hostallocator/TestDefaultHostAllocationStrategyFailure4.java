...
/**
 * backup storage the image is on is not attached, failure
 */
public class TestDefaultHostAllocationStrategyFailure4 {
    Deployer deployer;
    Api api;
    ...
    public void setUp() throws Exception {
        DBUtil.reDeployDB();
        deployer = new Deployer("deployerXml/hostAllocator/TestHostAllocatorFailure4.xml");
        deployer.build();
        api = deployer.getApi();
