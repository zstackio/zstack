...
/**
 * no host has enough capacity, failure
 */
public class TestDefaultHostAllocationStrategyFailure3 {
    Deployer deployer;
    Api api;
    ...
    public void setUp() throws Exception {
        DBUtil.reDeployDB();
        deployer = new Deployer("deployerXml/hostAllocator/TestHostAllocatorFailure3.xml");
        deployer.build();
        api = deployer.getApi();
