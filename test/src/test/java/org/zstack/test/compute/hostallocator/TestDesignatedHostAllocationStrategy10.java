 ...
 */
public class TestDesignatedHostAllocationStrategy10 {
    Deployer deployer;
    Api api;
    ...
    public void test() throws ApiSenderException {
        ...
        String itag = PrimaryStorageSystemTags.PRIMARY_STORAGE_ALLOCATOR_UUID_TAG.instantiateTag(map(e("uuid", ps2.getUuid())));
