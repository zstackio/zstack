...
public class TestImageStoreCloneVmCheckQuota {
    private CLogger logger = Utils.getLogger(TestImageStoreCloneVmCheckQuota.class);
    ...
    public void test() throws ApiSenderException {
        ...
        creator.session = api.loginByAccount(testAccount.getName(), "password");
        api.updateQuota(testAccount.getUuid(), ImageConstant.QUOTA_IMAGE_NUM, 0);
        ...
        Assert.assertTrue(numOfClonedVm == 0);
    }
}
