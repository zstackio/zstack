...
public class TestChangeImageState {
    CLogger logger = Utils.getLogger(TestChangeImageState.class);
    Api api;
    ...
    public void test() throws ApiSenderException {
        ...
        iinv = api.changeImageState(iinv.getUuid(), ImageStateEvent.disable);
        Assert.assertEquals(ImageState.Disabled.toString(), iinv.getState());
        iinv = api.changeImageState(iinv.getUuid(), ImageStateEvent.enable);
        Assert.assertEquals(ImageState.Enabled.toString(), iinv.getState());
    }
}
