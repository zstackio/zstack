 ...
 * test vm quota usage
 */
public class TestQuotaUsageForActualSize {
    Deployer deployer;
    Api api;
    ...
    public void test() throws ApiSenderException, InterruptedException {
        ...
        iinv.setSize(1073741824L);//1G
        iinv.setActualSize(536870912L);//0.5G
        ...
        Assert.assertEquals(qvm.getValue(), imageSize.getUsed().longValue());
