...
public class TestVirtualRouterEip21 {
    ...
    public void setUp() throws Exception {
        ...
        deployer = new Deployer("deployerXml/eip/TestVirtualRouterEip21.xml", con);
    ...
    public void test() throws ApiSenderException {
        ...
        VmNicInventory nic = vm2.getVmNics().get(0);
        api.createEip("eip2", eip1.getVipUuid(), nic.getUuid());
    }
}
