 ...
 */
public class TestVirtualRouterEip19 {
    Deployer deployer;
    Api api;
    ...
    public void test() throws ApiSenderException {
        ...
        Assert.assertEquals(nic.getUuid(), eip.getVmNicUuid());
        ref = Q.New(VipNetworkServicesRefVO.class).select(VipNetworkServicesRefVO_.serviceType).eq(VipNetworkServicesRefVO_.uuid,eip.getUuid()).find();
        Assert.assertEquals(EipConstant.EIP_NETWORK_SERVICE_TYPE, ref);
    }
}
