...
public class TestUpdateVirtualRouterEip {
    Deployer deployer;
    Api api;
    ...
    public void test() throws ApiSenderException {
        ...
        eip.setName("1");
        eip.setDescription("xxx");
        eip = api.updateEip(eip);

        Assert.assertEquals("1", eip.getName());
        Assert.assertEquals("xxx", eip.getDescription());
    }
}
