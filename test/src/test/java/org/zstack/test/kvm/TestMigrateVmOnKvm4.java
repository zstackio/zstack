...
/**
 * migrate vm to another cluster which doesn't have l2Network vm on attached
 * should fail
 */
public class TestMigrateVmOnKvm4 {
    ...
    public void setUp() throws Exception {
        ...
        deployer = new Deployer("deployerXml/kvm/TestMigrateVmOnKvm4.xml", con);
