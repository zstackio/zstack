...
public class TestKvmAttachL2Network5 {
    static CLogger logger = Utils.getLogger(TestKvmAttachL2Network5.class);
    ...
    public static void setUp() throws Exception {
        ...
        deployer = new Deployer("deployerXml/kvm/TestKvmAttachL2Network5.xml", con);
    ...
    public void test() throws ApiSenderException {
        ...
        Assert.assertEquals(2, config.vlanBridges.size());
        config.vlanBridges.clear();
        HostInventory host = deployer.hosts.get("host1");
        api.reconnectHost(host.getUuid());
        Assert.assertEquals(1, config.vlanBridges.size());
    }
}
