...
public class TestAddKvmHostFactException {
    static CLogger logger = Utils.getLogger(TestAddKvmHostFactException.class);
    ...
    public void testHostFactFailure() throws ApiSenderException {
        config.connectSuccess = true;
        config.connectException = false;
        config.hostFactException = true;
        addHost();
    }
}
