...
/**
 */
public class TestFutureReturnValueCompletion3 {
    CLogger logger = Utils.getLogger(TestFutureReturnValueCompletion3.class);
    ...
    public void test() throws InterruptedException {
        ...
        Assert.assertEquals(SysErrors.INTERNAL.toString(), completion.getErrorCode().getCode());
    }
}
