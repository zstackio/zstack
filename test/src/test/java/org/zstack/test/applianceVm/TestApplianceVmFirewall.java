...
public class TestApplianceVmFirewall {
    Deployer deployer;
    Api api;
    ...
    public void test() throws ApiSenderException, InterruptedException {
        ...
        apvmf.createApplianceVm(spec, new ReturnValueCompletion<ApplianceVmInventory>(null) {
            ...
            public void success(ApplianceVmInventory vm) {
                try {
                    final VmNicInventory vmgmtNic = findNic(vm.getVmNics(), mgmtNic.getL3NetworkUuid());
                    ...
                    Assert.assertNull(to.getSourceIp());
                    Assert.assertNull(to.getDestIp());
                    Assert.assertNull(to.getAllowCidr());
