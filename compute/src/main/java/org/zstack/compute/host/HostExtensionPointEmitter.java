...
public class HostExtensionPointEmitter implements Component {
	...
	private List<HostPingTaskExtensionPoint> pingTaskExts = new ArrayList<HostPingTaskExtensionPoint>();
	private List<HostDeleteExtensionPoint> deleteHostExts = new ArrayList<HostDeleteExtensionPoint>();
	private List<HostChangeStateExtensionPoint> changeStateExts = new ArrayList<HostChangeStateExtensionPoint>();
	private List<HostConnectionReestablishExtensionPoint> connetionReestablishExts = new ArrayList<HostConnectionReestablishExtensionPoint>();
    private List<HostAddExtensionPoint> addHostExts = new ArrayList<HostAddExtensionPoint>();
