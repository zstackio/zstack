...
public class VmAllocateHostAndPrimaryStorageFlow implements Flow {
    ...
    public void run(final FlowTrigger trigger, final Map data) {
        ...
        for (PsGroups possiblePsUuids : sortedPsGroup) {
            ...
            localPsUuids.addAll(temporaryLocalPsUuids);
            nonLocalPsUuids.addAll(temporaryNonLocalPsUuids);

            availablePsUuids.addAll(temporaryLocalPsUuids);
            availablePsUuids.addAll(temporaryNonLocalPsUuids);
