    ...
    public final static HashMap<String, String> srcToDstMapping = new HashMap() {
        {
			...
			put("org.zstack.network.hostNetwork.lldp.entity.HostNetworkInterfaceLldpInventory", "org.zstack.sdk.HostNetworkInterfaceLldpInventory");
			put("org.zstack.network.hostNetwork.lldp.entity.HostNetworkInterfaceLldpRefInventory", "org.zstack.sdk.HostNetworkInterfaceLldpRefInventory");
    ...
    public final static HashMap<String, String> dstToSrcMapping = new HashMap() {
        {
			...
			put("org.zstack.sdk.HostNetworkInterfaceLldpInventory", "org.zstack.network.hostNetwork.lldp.entity.HostNetworkInterfaceLldpInventory");
			put("org.zstack.sdk.HostNetworkInterfaceLldpRefInventory", "org.zstack.network.hostNetwork.lldp.entity.HostNetworkInterfaceLldpRefInventory");
