...
public class QueryZsDatasetTaskAction extends AbstractAction {
    ...
    public static class Result {
        ...
        public org.zstack.sdk.QueryZsDatasetTaskResult value;
    ...
    @Param(required = true, validRegexValues = "^[a-z][a-z-]{0,63}$", nonempty = false, nullElements = false, emptyString = true, noTrim = false)
    ...
    private Result makeResult(ApiResult res) {
        ...
        org.zstack.sdk.QueryZsDatasetTaskResult value = res.getResult(org.zstack.sdk.QueryZsDatasetTaskResult.class);
        ret.value = value == null ? new org.zstack.sdk.QueryZsDatasetTaskResult() : value; 
    ...
    protected RestInfo getRestInfo() {
        ...
        info.httpMethod = "GET";
        info.path = "/ai/zsdataset/spaces/{spaceUuid}/task-queries";
