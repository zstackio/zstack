...
public class UpdateSanSecSecretResourcePoolAction extends AbstractAction {
    ...
    public java.lang.Integer keyIndex;
    ...
    @Param(required = false, nonempty = false, nullElements = false, emptyString = true, noTrim = false)
    public java.lang.String sm3Key;
    ...
    protected RestInfo getRestInfo() {
        ...
        info.httpMethod = "PUT";
        info.path = "/secret-resource-pools/sanSec/{uuid}/actions";
        info.needSession = true;
        info.needPoll = true;
        info.parameterName = "updateSanSecSecretResourcePool";
        return info;
    }
