...
public class SubmitZsDatasetDocumentProcessingTaskAction extends AbstractAction {
    ...
    public static class Result {
        ...
        public org.zstack.sdk.SubmitZsDatasetDocumentProcessingTaskResult value;
    ...
    public org.zstack.sdk.ZsDatasetSegmentationConfigSpec segmentation;

    @Param(required = false, validValues = {"BUILTIN","MINERU","VISION"}, nonempty = false, nullElements = false, emptyString = true, noTrim = false)
    public java.lang.String parserStrategy;

    @Param(required = false, validRegexValues = "^[A-Za-z0-9_-]{1,128}$", nonempty = false, nullElements = false, emptyString = true, noTrim = false)
    public java.lang.String parserModelProfileId;
    ...
    private Result makeResult(ApiResult res) {
        ...
        org.zstack.sdk.SubmitZsDatasetDocumentProcessingTaskResult value = res.getResult(org.zstack.sdk.SubmitZsDatasetDocumentProcessingTaskResult.class);
        ret.value = value == null ? new org.zstack.sdk.SubmitZsDatasetDocumentProcessingTaskResult() : value; 
