...
public class GetGpuResourceTreeAction extends AbstractAction {
    ...
    @Param(required = false, validValues = {"VM","BARE_METAL","CONTAINER"}, nonempty = false, nullElements = false, emptyString = true, noTrim = false)
    public java.lang.String scope;

    @Param(required = false, validValues = {"Allocated","Unallocated","Unallocatable"}, nonempty = false, nullElements = false, emptyString = true, noTrim = false)
