...
public class RetryZsDatasetTaskAction extends AbstractAction {
    ...
    public static class Result {
        ...
        public org.zstack.sdk.RetryZsDatasetTaskResult value;
    ...
    @Param(required = true, validRegexValues = "^[A-Za-z0-9_-]{1,128}$", nonempty = false, nullElements = false, emptyString = true, noTrim = false)
    public java.lang.String newTaskId;
    ...
    private Result makeResult(ApiResult res) {
        ...
        org.zstack.sdk.RetryZsDatasetTaskResult value = res.getResult(org.zstack.sdk.RetryZsDatasetTaskResult.class);
        ret.value = value == null ? new org.zstack.sdk.RetryZsDatasetTaskResult() : value; 
    ...
    protected RestInfo getRestInfo() {
        ...
        info.path = "/ai/zsdataset/spaces/{spaceUuid}/tasks/{taskId}/retries";
