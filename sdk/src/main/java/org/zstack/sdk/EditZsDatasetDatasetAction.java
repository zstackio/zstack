...
public class EditZsDatasetDatasetAction extends AbstractAction {
    ...
    public static class Result {
        ...
        public org.zstack.sdk.EditZsDatasetDatasetResult value;
    ...
    @Param(required = false, maxLength = 100000, nonempty = false, nullElements = false, emptyString = true, noTrim = false)
    ...
    @Param(required = false, nonempty = false, nullElements = false, emptyString = true, numberRange = {0L,5L}, noTrim = false)
    ...
    private Result makeResult(ApiResult res) {
        ...
        org.zstack.sdk.EditZsDatasetDatasetResult value = res.getResult(org.zstack.sdk.EditZsDatasetDatasetResult.class);
        ret.value = value == null ? new org.zstack.sdk.EditZsDatasetDatasetResult() : value; 
    ...
    protected RestInfo getRestInfo() {
        ...
        info.path = "/ai/zsdataset/spaces/{spaceUuid}/datasets/{datasetId}/edit";
