...
public class UpdateFlkSecSecurityMachineAction extends AbstractAction {
    ...
    protected RestInfo getRestInfo() {
        ...
        info.httpMethod = "PUT";
        info.path = "/security-machines/flkSec/{uuid}/actions";
        info.needSession = true;
        info.needPoll = true;
        info.parameterName = "updateFlkSecSecurityMachine";
        return info;
    }
