...
public class UpdateS3BackupStorageAction extends AbstractAction {
    ...
    @Param(required = false, maxLength = 63, minLength = 3, nonempty = false, nullElements = false, emptyString = true, noTrim = false)
    ...
    protected RestInfo getRestInfo() {
        ...
        info.httpMethod = "PUT";
        info.path = "/backup-storage/s3/{uuid}/actions";
        info.needSession = true;
        info.needPoll = true;
        info.parameterName = "updateS3BackupStorage";
        return info;
    }
