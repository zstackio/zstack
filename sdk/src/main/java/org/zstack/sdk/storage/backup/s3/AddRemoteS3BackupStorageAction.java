...
public class AddRemoteS3BackupStorageAction extends AbstractAction {
    ...
    @Param(required = true, maxLength = 63, minLength = 3, nonempty = false, nullElements = false, emptyString = false, noTrim = false)
    ...
    protected RestInfo getRestInfo() {
        ...
        info.path = "/backup-storage/s3/remote";
