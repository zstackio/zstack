...
public class CreateGuestVmScriptAction extends AbstractAction {
    ...
    @Param(required = true, validValues = {"Base64","PlainText"}, nonempty = false, nullElements = false, emptyString = true, noTrim = false)
    public java.lang.String encodingType = "Base64";
