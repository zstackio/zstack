...
public class UpdateFlkSecSecretResourcePoolAction extends AbstractAction {
    ...
    @Param(required = false, maxLength = 64, minLength = 4, nonempty = false, nullElements = false, emptyString = true, noTrim = false)
    ...
    protected RestInfo getRestInfo() {
        ...
        info.httpMethod = "PUT";
        info.path = "/secret-resource-pools/flkSec/{uuid}/actions";
        info.needSession = true;
        info.needPoll = true;
        info.parameterName = "updateFlkSecSecretResourcePool";
        return info;
    }
