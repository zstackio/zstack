...
public class ListZsDatasetQuestionsAction extends AbstractAction {
    ...
    public static class Result {
        ...
        public org.zstack.sdk.ListZsDatasetQuestionsResult value;
    ...
    @Param(required = false, validValues = {"text","image"}, nonempty = false, nullElements = false, emptyString = true, noTrim = false)
    ...
    private Result makeResult(ApiResult res) {
        ...
        org.zstack.sdk.ListZsDatasetQuestionsResult value = res.getResult(org.zstack.sdk.ListZsDatasetQuestionsResult.class);
        ret.value = value == null ? new org.zstack.sdk.ListZsDatasetQuestionsResult() : value; 
    ...
    protected RestInfo getRestInfo() {
        ...
        info.httpMethod = "GET";
        info.path = "/ai/zsdataset/spaces/{spaceUuid}/questions";
