...
public class EditZsDatasetChunkAction extends AbstractAction {
    ...
    public static class Result {
        ...
        public org.zstack.sdk.EditZsDatasetChunkResult value;
    ...
    @Param(required = false, maxLength = 200000, nonempty = false, nullElements = false, emptyString = true, noTrim = false)
    ...
    private Result makeResult(ApiResult res) {
        ...
        org.zstack.sdk.EditZsDatasetChunkResult value = res.getResult(org.zstack.sdk.EditZsDatasetChunkResult.class);
        ret.value = value == null ? new org.zstack.sdk.EditZsDatasetChunkResult() : value; 
    ...
    protected RestInfo getRestInfo() {
        ...
        info.path = "/ai/zsdataset/spaces/{spaceUuid}/chunks/{chunkId}/edit";
