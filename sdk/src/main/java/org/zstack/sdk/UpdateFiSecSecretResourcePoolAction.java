...
public class UpdateFiSecSecretResourcePoolAction extends AbstractAction {
    ...
    protected RestInfo getRestInfo() {
        ...
        info.httpMethod = "PUT";
        info.path = "/secret-resource-pools/fiSec/{uuid}/actions";
        info.needSession = true;
        info.needPoll = true;
        info.parameterName = "updateFiSecSecretResourcePool";
        return info;
    }
