...
public class CreateSchedulerJobGroupAction extends AbstractAction {
    ...
    @Param(required = true, validValues = {"startVm","stopVm","rebootVm","volumeSnapshot","volumeBackup","rootVolumeBackup","vmBackup","databaseBackup","runAutoScalingGroup","cancelIAM2ProjectLoginExpired","takeIAM2ProjectLoginExpired"}, nonempty = false, nullElements = false, emptyString = true, noTrim = false)
