...
public class UpdateImageAction extends AbstractAction {
    ...
    @Param(required = false, validValues = {"x86_64","aarch64","mips64el","loongarch64","sw_64"}, maxLength = 32, nonempty = false, nullElements = false, emptyString = true, noTrim = false)
