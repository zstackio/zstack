...
public class AlarmInventory  {
    ...
    public java.util.List<AlarmLabelInventory> labels;
    public void setLabels(java.util.List<AlarmLabelInventory> labels) {
        this.labels = labels;
    }
    public java.util.List<AlarmLabelInventory> getLabels() {
        return this.labels;
    }

    public java.util.List<AlarmActionInventory> actions;
    public void setActions(java.util.List<AlarmActionInventory> actions) {
        this.actions = actions;
    }
    public java.util.List<AlarmActionInventory> getActions() {
        return this.actions;
    }
