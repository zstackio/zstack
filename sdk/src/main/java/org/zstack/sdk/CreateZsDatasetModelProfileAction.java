...
public class CreateZsDatasetModelProfileAction extends AbstractAction {
    ...
    public static class Result {
        ...
        public org.zstack.sdk.CreateZsDatasetModelProfileResult value;
    ...
    @Param(required = true, validValues = {"TEXT","VISION","PARSER"}, nonempty = false, nullElements = false, emptyString = true, noTrim = false)
    ...
    private Result makeResult(ApiResult res) {
        ...
        org.zstack.sdk.CreateZsDatasetModelProfileResult value = res.getResult(org.zstack.sdk.CreateZsDatasetModelProfileResult.class);
        ret.value = value == null ? new org.zstack.sdk.CreateZsDatasetModelProfileResult() : value; 
