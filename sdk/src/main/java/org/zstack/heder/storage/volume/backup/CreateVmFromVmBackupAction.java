...
/**
 * @Deprecated
 * use {@link org.zstack.sdk.storage.volumebackup.CreateVmFromVmBackupAction}.
 * this class will removed in zsv_5.4.0
 */
@Deprecated
public class CreateVmFromVmBackupAction extends AbstractAction {
    ...
    public static class Result {
        ...
        public org.zstack.heder.storage.volume.backup.CreateVmFromVmBackupResult value;
    ...
    private Result makeResult(ApiResult res) {
        ...
        org.zstack.heder.storage.volume.backup.CreateVmFromVmBackupResult value = res.getResult(org.zstack.heder.storage.volume.backup.CreateVmFromVmBackupResult.class);
        ret.value = value == null ? new org.zstack.heder.storage.volume.backup.CreateVmFromVmBackupResult() : value; 
    ...
    protected RestInfo getRestInfo() {
        ...
        info.path = "/vm-instances/from/vm-backups/{groupUuid}";
