...
public class CreateBareMetal2InstanceFromVmBackupAction extends AbstractAction {
    ...
    public static class Result {
        ...
        public org.zstack.heder.storage.volume.backup.CreateBareMetal2InstanceFromVmBackupResult value;
    ...
    private Result makeResult(ApiResult res) {
        ...
        org.zstack.heder.storage.volume.backup.CreateBareMetal2InstanceFromVmBackupResult value = res.getResult(org.zstack.heder.storage.volume.backup.CreateBareMetal2InstanceFromVmBackupResult.class);
        ret.value = value == null ? new org.zstack.heder.storage.volume.backup.CreateBareMetal2InstanceFromVmBackupResult() : value; 
    ...
    protected RestInfo getRestInfo() {
        ...
        info.path = "/baremetal2-instance/from/vm-backup/{groupUuid}";
