...
import org.zstack.header.configuration.APIGenerateApiJsonTemplateEvent;
import org.zstack.header.configuration.APIGenerateApiJsonTemplateMsg;
import org.zstack.header.configuration.APIGenerateGroovyClassEvent;
import org.zstack.header.configuration.APIGenerateGroovyClassMsg;
import org.zstack.header.configuration.APIGenerateSqlForeignKeyEvent;
import org.zstack.header.configuration.APIGenerateSqlForeignKeyMsg;
import org.zstack.header.configuration.APIGenerateSqlIndexEvent;
import org.zstack.header.configuration.APIGenerateSqlIndexMsg;
import org.zstack.header.configuration.APIGenerateSqlVOViewEvent;
import org.zstack.header.configuration.APIGenerateSqlVOViewMsg;
import org.zstack.header.configuration.APIGenerateTestLinkDocumentEvent;
import org.zstack.header.configuration.APIGenerateTestLinkDocumentMsg;
...
import org.zstack.header.configuration.DiskOfferingMessage;
...
import org.zstack.header.configuration.InstanceOfferingMessage;
